...
class php
{
    ...
    public function __construct(Request $request, array $parametes = array())
    {
        ...
        define('CKFINDER_CONNECTOR_LANG_PATH', $this->parameters['path'] . "/core/connector/php/lang");
        ...
        define('CKFINDER_CONNECTOR_LIB_DIR', $this->parameters['path'] . "/core/connector/php/php5");
